...
apples = 2
banana = apples * 4
print("Кількість бананнів становить", banana, "шт., що в 4 рази більша ніж явблук, яких -", apples, "шт.")

# task 05 == виправте назви змінних

# більш інтуітивно зрозуміліше було б назвати змінні однаково, а порядковість позначити як "_1", "_2", "_3", "_4"
storona_1 = 1   # хоча можна було просто прибрати "1" та залишиит "_storona"
storona_2 = 2
storona_3 = 3
storona_4 = 4
